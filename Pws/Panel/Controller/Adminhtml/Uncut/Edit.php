...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Pws_Panel::uncut_edit');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Pws_Panel::panel')
            ...
            ->addBreadcrumb(__('Manage Panels'), __('Manage uncut products'));
        return $resultPage;
    }
    ...
    public function execute()
    {
    	...
    	if($id){
    		$model->load($id);
    		if(!$model->getId()){
    			$this->messageManager->addError(__('This Product is no longer exits. '));
        ...
        $resultPage->addBreadcrumb(
            $id ? __('Edit Panel') : __('New Product'),
            $id ? __('Edit Panel') : __('New Product')
        );
